...
namespace PlayerScripts
{
    ...
    public class PlayerStatsController : MonoBehaviour
    {
        ...
        /// <summary>
        /// Removes health and sets of game endinging on death
        /// </summary>
        public void Damage()
        {
            if (playerStats.CurrentHealth > 0) playerStats.CurrentHealth -= 1f;
            _healthBar.value = (int)Mathf.Ceil(playerStats.CurrentHealth);
            if (playerStats.CurrentHealth == 0) GameStateController.Instance.OnGameEnd();
        }
    }
}
